  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-12">
      ...
      <div className="fixed inset-0 -z-10">
        ...
        <div className="absolute top-1/3 right-1/4 w-[500px] h-[500px] bg-gradient-radial from-accent-blue/10 via-transparent to-transparent" />
      </div>
        ...
        <div className="w-full max-w-md mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-fg-muted">
              Continue your personalized thrifting journey
            </p>
          </div>
          ...
          <div className="bg-canvas-subtle border border-border rounded-2xl p-6">
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-canvas-subtle px-2 text-fg-muted">
                  Or continue with
                </span>
              </div>
            </div>
